...
//                updateUI(R.string.lemon_select,R.drawable.lemon_tree)
//
//            }
//            SQUEEZE -> {
//                textAction.setText(R.string.lemon_squeeze)
//                lemonImage?.setImageResource(R.drawable.lemon_squeeze)
//                updateUI(R.string.lemon_squeeze,R.drawable.lemon_squeeze)
//            }
//            DRINK -> {
//                textAction.setText(R.string.lemon_drink)
//                lemonImage?.setImageResource(R.drawable.lemon_drink)
//                updateUI(R.string.lemon_drink,R.drawable.lemon_drink)
//            }
//            RESTART -> {
//                textAction.setText(R.string.lemon_empty_glass)
//                lemonImage?.setImageResource(R.drawable.lemon_restart)
//                updateUI(R.string.lemon_empty_glass,R.drawable.lemon_restart)
//            }
//
//        }
        when (lemonadeState) {
